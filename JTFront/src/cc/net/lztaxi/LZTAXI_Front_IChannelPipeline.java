...
public class LZTAXI_Front_IChannelPipeline implements IChannelPipeline{

	
	@Override
	public void initPipeline(SocketChannel ch) throws Exception {
		//ICreatCheckPacket iccp=new LZTAXI_Front_CreateCheckPacket();
		ch.pipeline().addLast(
                //new LoggingHandler(LogLevel.INFO),
       		 //new IdleStateHandler(60, 30, 0),
       		 new LZTAXI_GPSDecoder(),//2014-3-25
