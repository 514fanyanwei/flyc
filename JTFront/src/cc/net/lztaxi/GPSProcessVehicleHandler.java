...
import cc.gps.active.lztaxi.LZTAXIProcessReceive;
...
public class GPSProcessVehicleHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
    	...
    	IProcessReceive process=new LZTAXIProcessReceive();
    	...
    	String mid=Ecode.DEC2HEX(in2.getUnsignedByte(4),2);
    	String order=Recourse.getOrder("lztaxi00"+mid);
