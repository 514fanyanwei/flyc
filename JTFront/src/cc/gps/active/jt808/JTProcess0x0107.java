...
import cc.gps.parse.jt808.PJT0x0107;
import cc.gps.parse.jt808.PJT0x0301;
import cc.gps.util.Ecode;

public class JTProcess0x0107 extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0107.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0107")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0107 pjt=new PJT0x0107(inData.bb);
		pjt.convert();
