...
public class JTProcess0x0702  extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0702.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0702")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0702 pjt=new PJT0x0702(inData.bb);
		pjt.convert();
