...
import cc.gps.parse.jt808.PJT0x0900;
import cc.gps.util.Ecode;

public class JTProcess0x0900 extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0900.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0900")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0900 pjt=new PJT0x0900(inData.bb,inData.head.len);
		pjt.convert();
