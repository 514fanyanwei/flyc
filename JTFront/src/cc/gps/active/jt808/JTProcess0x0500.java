...
import cc.gps.parse.jt808.PJT0x0500;
import cc.gps.parse.jt808.PJT0x0702;
import cc.gps.util.Ecode;

public class JTProcess0x0500 extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0500.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0500")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0500 pjt=new PJT0x0500(inData.bb);
		pjt.convert();
		...
		//对应平台消息消息ID
		int ptMessageID=0x8500;  //是对0x8500的应答
