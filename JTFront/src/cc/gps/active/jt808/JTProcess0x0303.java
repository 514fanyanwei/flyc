...
import cc.gps.parse.jt808.PJT0x0302;
import cc.gps.parse.jt808.PJT0x0303;
import cc.gps.util.Ecode;

public class JTProcess0x0303 extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0303.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0303")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0303 pjt=new PJT0x0303(inData.bb);
		pjt.convert();
