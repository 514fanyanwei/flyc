...
public class JTBuild0x8100 extends JTBuildSendPacket {
	private static final Log log = LogFactory.getLog(JTBuild0x8100.class);
	...
	public  byte[] buildSendPacket(JTReceiveData data){
		...
		log.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"+JTBuild0x8100.getHexString(bs));
		return bs;
	}
	@Override
