...
import cc.gps.parse.jt808.PJT0x0701;
import cc.gps.parse.jt808.PJT0x0702;
import cc.gps.util.Ecode;

public class JTProcess0x0701 extends JTProcessReceive{
private static final Log log = LogFactory.getLog(JTProcess0x0701.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData inData) {
		if(log.isDebugEnabled())
			log.info("处理来自"+inData.head.phone+"的"+Recourse.getOrder("0x0701")+":-------------");
		...
		//JTDataImage jt=
		PJT0x0701 pjt=new PJT0x0701(inData.bb,inData.head.len);
		pjt.convert();
