...
public class LZBusBuildSendPacket extends IBuildSendPacket{
	...
	public LZBusBuildSendPacket(){}
	
	public LZBusBuildSendPacket(int messageID){
	...
	public  boolean buildSendPacket(String clientID,Object content,int serialID){
		log.info("蓝斯公交报文下发0X"+Ecode.DEC2HEX(messageID));
