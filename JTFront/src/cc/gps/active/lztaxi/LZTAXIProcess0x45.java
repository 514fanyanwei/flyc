...
public class LZTAXIProcess0x45  extends LZTAXIProcessReceive{
	private static final Log log = LogFactory.getLog(LZTAXIProcess0x45.class);
	
	@Override
	public byte[] processMessageBody(JTReceiveData data) {
		if(log.isDebugEnabled())
			log.info("处理来自"+data.head.phone+"的"+Recourse.getOrder("lzbtaxi0045")+":-------------");
		C2XAnswer td = new C2XAnswer();
		LZTAXI0x45 lz=new LZTAXI0x45(data.bb);
