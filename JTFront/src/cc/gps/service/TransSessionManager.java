...
public class TransSessionManager  {
	...
	/* 单例 */
    private static TransSessionManager instance ;//= ThreadPool.getInstance();
    

    public static synchronized TransSessionManager getInstance() {
    	if (instance == null){
    		instance=new TransSessionManager();
    	}
        return instance;
    }
