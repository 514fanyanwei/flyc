...
public class BusinessSessionManager {
	...
	/* 单例 */
    private static BusinessSessionManager instance ;//= ThreadPool.getInstance();
    

    public static synchronized BusinessSessionManager getInstance() {
    	if (instance == null){
    		instance=new BusinessSessionManager();
    	}
        return instance;
    }
     ...
     */
    private BusinessSessionManager() {
            super();
    }
    ...
    /** @modelguid {172828D6-3AB2-46C4-96E2-E72B34264032} */
