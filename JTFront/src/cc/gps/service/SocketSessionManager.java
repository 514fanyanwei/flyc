...
public class SocketSessionManager {
	...
	/* 单例 */
    private static SocketSessionManager instance ;//= ThreadPool.getInstance();
    

    public static synchronized SocketSessionManager getInstance() {
    	if (instance == null){
    		instance=new SocketSessionManager();
    	}
        return instance;
    }
    ...
    /** @modelguid {172828D6-3AB2-46C4-96E2-E72B34264029} */
