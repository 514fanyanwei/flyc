...
public class MonitorSessionManager {
	 private static HashMap cacheMap = new HashMap();
		...
		/* 单例 */
	    private static MonitorSessionManager instance ;//= ThreadPool.getInstance();
	    

	    public static synchronized MonitorSessionManager getInstance() {
	    	if (instance == null){
	    		instance=new MonitorSessionManager();
	    	}
	        return instance;
	    }
