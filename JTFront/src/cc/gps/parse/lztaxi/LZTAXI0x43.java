...
public class LZTAXI0x43  {
	private static final Log log = LogFactory.getLog(LZTAXI0x43.class);
		...
		for(int i=0;i<bin.length();i++){
			switch(i){
				...
				case 19:
					...
					if(bin.charAt(31-i)=='1') st.replace(22, 23, "1"); break;  //重车 1  空车 0   st 6位
				case 20:
