...
public class LZTAXISendData extends SendData{
	...
	private static final Log log = LogFactory.getLog(LZTAXISendData.class);
	/*
	 * 
	...
	public byte[] toByte()   //将下发终端的数据生成byte数组
	{
		...
		String slen=Ecode.DEC2HEXLH(len);
		//String slen=Ecode.DEC2HEXLH(337);
		//log.info(slen);
		while(slen.length()<4){
			slen="0"+slen;
		}
